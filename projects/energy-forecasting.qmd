...
The write-up above covers the headline results — the full report walks
through the complete methodology in detail: the validation design, all 60
engineered features, the OLS/XGBoost/AR stacking rationale, and the
round-by-round competition log.

<iframe src="../files/energy-forecasting/energy-forecasting-report.pdf" width="100%" height="800px" style="border:1px solid #ddd;"></iframe>

[Open report in a new tab ↗](../files/energy-forecasting/energy-forecasting-report.pdf){target="_blank"}
