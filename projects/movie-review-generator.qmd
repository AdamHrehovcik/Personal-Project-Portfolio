...
The write-up above covers the headline results — the full report includes
the complete tokenisation rationale, the trigram smoothing derivation, the
architecture search (what was tried and rejected for the LSTM), and a
reflection on using LLMs as a study/work tool (Part 5 of the assignment).

<iframe src="../files/movie-review-generator/movie-review-generator-report.pdf" width="100%" height="800px" style="border:1px solid #ddd;"></iframe>

[Open report in a new tab ↗](../files/movie-review-generator/movie-review-generator-report.pdf){target="_blank"}
