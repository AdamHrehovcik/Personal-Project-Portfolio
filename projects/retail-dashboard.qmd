...
<!-- TODO: once deployed to Streamlit Community Cloud, replace this comment with:

<iframe src="STREAMLIT_APP_URL" width="100%" height="800px" style="border:1px solid #ddd;"></iframe>

[Open dashboard in a new tab ↗](STREAMLIT_APP_URL){target="_blank"}

Deploy without setting the GROQ_API_KEY secret so the dashboard is safe to
embed publicly — every chart, forecast, and recommendation works fully
without it; only the AI Q&A panels show a graceful "add your own key"
message instead of calling out to Groq on a random visitor's behalf. -->
